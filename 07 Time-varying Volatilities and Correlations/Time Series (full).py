...
res_CLP = arch_model(u2, mean='Zero', vol='GARCH', p=1, q=1).fit()
print(res_CLP.params.values)
print(res_CLP.loglikelihood) # compute log-likelihood value

res_CK = arch_model(u3, mean='Zero', vol='GARCH', p=1, q=1).fit()
print(res_CK.params.values)
print(res_CK.loglikelihood) # compute log-likelihood value

#%%

print(res_HSBC.summary())
print(res_CLP.summary())
print(res_CK.summary())
